...
exports.loadEvents = exports.load = exports.getLoader = exports.default = void 0;
...
var getLoader = function getLoader() {
  return new _dataloader.default(function (ids) {
    return (0, _graphqlMongooseLoader.mongooseLoader)(_EventModel.default, ids);
  });
};
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            _context.next = 5;
            return context.dataloaders.EventLoader.load(id);

          case 5:
            data = _context.sent;
            return _context.abrupt("return", viewerCanSee() ? new Event(data) : null);
...
function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            events = _EventModel.default.find(where, {
              _id: 1
            }).sort({
              createdAt: -1
            });
  ...
  return function loadEvents(_x3, _x4) {
